                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item">
                                        <a href="#" style="color: black"><i class=" nav-icon fa fa-home"></i> Hola</a>
                                    </li>
            ...
            <div class="modal fade " id="logoutmodal" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered justify-content-center" role="document">
                <div class="modal-content rounded col-md-12 px-0">
                  <div class="modal-header justify-content-center text-white" style="background-color: #ea0609"><h4> <i class="fa fa-power-off"></i><strong > Salir</strong></h4></div>
                  <div class="modal-body text-center" style="background-color:#ea0609">
                    <h5><i class="fas fa-sign-out-alt"></i> ¿Está seguro que desea cerrar sesión?</h5>
                  </div>
                  <div class="modal-footer" style="background-color: #ea0609">
